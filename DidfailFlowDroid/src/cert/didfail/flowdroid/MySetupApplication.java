...
public class MySetupApplication {
	 ...
	 *            inter-application data flows
	 */
	public MySetupApplication(String androidJar, String apkFileLocation, String additionalClasspath,
	...
	public InfoflowResults runInfoflow(ResultsAvailableHandler onResultsAvailable) {
		return runInfoflow(onResultsAvailable, null);
	}
	 ...
	 */
	public InfoflowResults runInfoflow(ResultsAvailableHandler onResultsAvailable,
			Collection<PreAnalysisHandler> preprocessors) {
		if (this.sourceSinkProvider == null)
